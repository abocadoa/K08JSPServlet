...
<body>
	...
	setName()이란 메서드가 없으므로 쿠키는 생성한후 쿠키명을
	변경하는것은 불가능하다.
	*/
	Cookie cookie=new Cookie("myCookie", "쿠키맛나요");
	/* 
	쿠키의 경로설정.
	컨텍트루스트 경로로 지정하므로 웹애플리케이션 전체에서 사용할 수
	있게된다.
	*/
	...
	*/
	...
	/* 여기까지의 코드를 통해 클라이언트 측에 쿠기가 생성된다. */
	%>
	...
	*/
	...
	클라이언트 측에 있는 쿠키를 서버로 다시 전송하기 위해 페이지이동을
	하거나 새로고침을 하여 새로운 요청을 보내야만 읽을 수 있다.
	*/
	%>
	
	<h2>3. 페이지 이동후 쿠기값 확인하기</h2>
