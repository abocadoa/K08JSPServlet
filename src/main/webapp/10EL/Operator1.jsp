...
<!DOCTYPE html>
<%
/* 예시에서 사용할 Java코드를 통한 일반적인 변수 선언 */
int num1=3;
/* page영역에 속성값 저장 */
...
<body>
	...
	<!-- 
	톰켓 8.0부터는 EL에서 변수 할당을 할 수 있다.
	하지만 변수할당과 동시에 출력되므로, 할당문 뒤에 ;''를 붙여줘야 출력되지
	않는다.
	...
	또한 자동형변환이 적용되므로 정수끼리의 연산에서 실수의 결과가 나올 수
	있다. -->
	...
	<!-- 
		...
		== : eq(EQual)
		!= : ne(Not Equal)
	Java에서 사용하던 기본적인 비교 연산자와 문자형태의 연산자 두가지 모두
	사용할 수 있다.
	 -->
	<h3>비교 연산자</h3>
	...
	<h3>논리 연산자</h3>
	num<=num4&&num3==num4:${num3 le num4 and num3 eq num4 } <br />
	num>=num4||num3!=num4:${num3 ge num4 or num3 ne num4 }
</body>
</html>