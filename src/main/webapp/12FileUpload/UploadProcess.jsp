...
try{
	...
	*/
	...
	파일명에 .(닷)을 여려개 사용할 수 있으므로 끝에서부터 찾는다.*/
	...
	여기서 사용된 separator는 경로를 표시할때 사용하는 구분기호로 윈도우의
	경우 \(역슬러쉬), 리눅스의 경우 /(슬러쉬)를 자동으로 부여해준다.
	File객체를 각각 생성한 후 renameTo()메소드를 통해 변경한다.
	*/
	...
	/* 
	파일을 제외한 나머지 폼값을 받는다.
	단, 이때 request내장객체를 통해서가 아니라 mr객체를 통해 받아야 하므로
	주의해야한다.
	객체는 다르지만 폼값을 받기위한 메소드명은 동일하다.
	*/
