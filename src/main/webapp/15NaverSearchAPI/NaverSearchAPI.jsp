...
$(function(){
	/* 
	한 페이지에서 2개 이상의 ajax()함수를 사용해야 할때 공통속성을 설정하기 위한 용도로
	사용된다.
	*/
	$.ajaxSetup({
		...
		success:sucFuncJson,		//요청 성공시 호출할 콜백메소드
		error:errFunc               //요청 실패시 호출할 콜백메소드
	});
...
function sucFuncJson(d){
	...
	/* 콜백된 JSON객체중에 itmes키에 저장된 배열의 개수만큼 반복해서 ul태그로 만든 후
	화면에 출력한다.*/
